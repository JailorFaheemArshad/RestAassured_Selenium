...
public class WenElementInterface {
	@Test
   ...
   //entering text into the focussed element
     driver.switchTo().activeElement().sendKeys("ashish");
	...
	public void removeValuefromText_usingClearMethod() throws InterruptedException {
         ...
         driver.get("https://www.facebook.com/");
         Thread.sleep(2000);
         driver.findElement(By.id("email")).sendKeys("ashishkumar@gmai.com");
         Thread.sleep(2000);
         ...
         Thread.sleep(2000);
         driver.findElement(By.id("email")).sendKeys("againEnteredashishkumar@gmai.com");
         Thread.sleep(2000);
